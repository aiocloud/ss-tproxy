...
cd /opt
git clone https://github.com.cnpmjs.org/shadowsocks/shadowsocks-libev --depth 1 || exit 1
...
cd /opt
git clone https://github.com.cnpmjs.org/shadowsocksrr/shadowsocksr-libev --depth 1 -b Akkariiin/develop || exit 1
